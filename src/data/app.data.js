...
export const sideListItems = [
  { id: 1, text: 'test1', icon: <AiFillHome size={24} /> },
  { id: 2, text: 'test2', icon: <MdOutlineExplore size={24} /> },
  { id: 3, text: 'test3', icon: <AiOutlinePlaySquare size={24} /> },
  { id: 4, text: 'test4', icon: <MdSubscriptions size={24} /> },
  { id: 5, divider: true },
  { id: 6, text: 'test5', icon: <BiLibrary size={24} /> },
  { id: 7, text: 'test6', icon: <MdHistory size={24} /> },
  { id: 8, text: 'test7', icon: <BiVideo size={24} /> },
  { id: 9, text: 'test8', icon: <BsStopwatch size={24} /> },
  { id: 10, subdivision: true, text: 'Explore' },
  { id: 11, text: 'test9', icon: <MdLocalMovies size={24} /> },
  { id: 12, text: 'test10', icon: <SiFacebookgaming size={24} /> },
  { id: 13, text: 'test11', icon: <SiLivechat size={24} /> },
  { id: 14, text: 'test12', icon: <GiLargeDress size={24} /> },
  ...
  { id: 19, text: 'test16', icon: <CgYoutube size={24} color="red" /> },
  { id: 20, divider: true },
